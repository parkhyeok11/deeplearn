...
if __name__ == '__main__':
    ...
    print("zero: %d, minus:%d, plus: %d" %
          (zero_pixels, minus_pixels, plus_pixels))

    mf = MF()
    print("train_start")
    mf.train(R=corrupted_pixels, k=16, reg_lambda=0.00,
             lr_alpha=0.1, max_iterations=50, epsilon=0.001)
    print("train_end")
    ...
    if reconst_pixels is None:
        ...
        print_img_list(original_pixels, corrupted_pixels,
                       reconst_pixels, corruption_rate)
